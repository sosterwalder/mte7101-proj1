...
$ I = I_a + k_d \displaystyle\sum_{j=1}^{ls} (\overline{N} \cdot \overline{L_j}) + k_s \displaystyle\sum_{j=1}^{ls} (\overline{N} \cdot \overline{L_j^`} ) $
% + k_s \displaystyle\sum_{j=1}^{js} (\overline{N} \cdot \overline{L}_j^2 )^n $
