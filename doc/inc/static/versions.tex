...
\begin{versionhistory}
    ...
    \vhEntry{0.2}{27.09.2015}{SO}{Entwickeln einer initialen Struktur,
        Aufbau der Dokumentation, Entwicklung~\autoref{chap:procedure}, Beschreibung von
        Ray Tracing in~\autoref{chap:theoretical_background}, Hinzufügen des
    ...
    \vhEntry{0.3}{29.09.2015}{SO}{Einführen von Meeting
        ...
        Kapitels~\ref{chap:theoretical_background} um Beleuchtungsmodelle, Beschreiben von
    ...
    \vhEntry{0.4}{04.10.2015}{SO}{Hinzufügen von Standards und
        ...
        Beleuchtungsmodelle~\ref{subsec:global_illumination_models} sowie Ray
    ...
    \vhEntry{0.5}{11.10.2015}{SO}{Neuordnung des
        Kapitels~\ref{chap:theoretical_background}: Hinzufügen
        des~\autoref{sec:ray_casting_tracing} über Ray Tracing
        sowie~\autoref{sec:description_implicit_surfaces} über
        Darstellung von impliziten Oberflächen.
    }
    ...
    \vhEntry{0.10}{21.10.2015}{SO}{Erweiterung Kapitel über Rendering
        von impliziten Oberflächen, Einführung
        des~\autoref{chap:prototype} über die Umsetzung eines Prototypen
    }
    ...
    \vhEntry{0.19}{28.12.2015}{SO}{Erweiterung des Kapitels über Modelle
        ...
        Modelle zur Schattierung, Abarbeiten von TODO-Notizen,
    ...
    \vhEntry{0.24}{09.01.2016}{SO}{Einleitung der
        ...
        Kapitel~\ref{subsec:implicit_surfaces}, Erarbeiten des
    ...
    \vhEntry{0.25}{10.01.2016}{SO}{Fertigstellung der
        \autoref{chap:scope}~\nameref{chap:scope}
        und~\autoref{chap:procedure}~\nameref{chap:procedure}, Abarbeiten
        und Nachführen von verbleibenden TODO-Notizen, Nachführen der
        Versionshistorie.
    }
    \vhEntry{0.90}{11.01.2016}{SO}{Überarbeitung der Dokumentation bis
        und mit~\autoref{chap:theoretical_background}, Nachführen der
        Versionshistorie.
    }
    \vhEntry{0.91}{13.01.2016}{SO}{Überarbeitung der Dokumentation
        ab~\autoref{chap:theoretical_background}, Verfassen
        von~\autoref{sec:further_work}~\nameref{sec:further_work},
        Nachführen der Versionshistorie.
    }
    \vhEntry{1.0}{13.01.2016}{SO}{Überarbeitung
        von~\autoref{chap:discussion_and_conclusion}~\nameref{chap:discussion_and_conclusion},
        Verfassen von~\autoref{chap:abstract}\nameref{chap:abstract},
        Nachführen der Versionshistorie.
    }
    \vhEntry{1.1}{14.02.2016}{SO}{Überarbeitung des gesamten Dokumentes
        hinsichtlich Rechtschreibung sowie Formulierung. Nachführen der
        Meeting Minutes vom 25.01.2016. Einarbeiten der besprochenen
        Punkte. Nachführen der Versionshistorie.
    }
\end{versionhistory}
