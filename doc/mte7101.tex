...
\renewcommand{\vhhistoryname}{Versionen}
%---------------------------------------------------------------------------

% Bibliography
%---------------------------------------------------------------------------
\addbibresource{inc/static/bibliography}
...
\input{inc/static/doc_title}                  % Titel der Arbeit aus Datei titel.tex lesen
...
\deftripstyle{newlayout}
  ...
  {}
  {}
  {\color{bfhgrey} \footnotesize \titel, Version \vhCurrentVersion, \vhCurrentDate}
  {}
